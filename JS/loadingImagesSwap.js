...
window.addEventListener('load', function() {
    ...
    setTimeout(() => {
      ...
      ScrollReveal().reveal('.subHeadingSlow', { delay: 900 });
      ScrollReveal().reveal('.exploreBtnSlow', { scale: 0.25, delay: 900 });

      // ScrollReveal().reveal('.ring1Slow', { scale: 0.25, delay: 1000, distance : "350px", origin : "top" });
